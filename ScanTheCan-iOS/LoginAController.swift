...
class LoginAController: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var companyLogin: UIButton!
    ...
    @IBAction func onCompanyLoginPressed(_ sender: Any) {
        self.performSegue(withIdentifier: "companylogin", sender: nil)
    }
